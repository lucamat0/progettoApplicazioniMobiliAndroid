...
class AdminLoginActivity : UserLoginActivity() {
    ...
    companion object {
         ...
         * @param userId Identificativo dell'utente
         */
        internal suspend fun eliminaUtente(userId: String) {
         ...
         * @return Numero di oggetti
         */
        internal suspend fun numeroOggettiInVenditaPerRaggioDistanza(posizioneUtente: Location, distanzaKmMax: Int): Int {
         ...
         */
        suspend fun classificaUtentiRecensitiConVotoPiuAlto(): ArrayList<Utente> {
